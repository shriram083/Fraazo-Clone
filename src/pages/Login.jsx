import { Button, FormControl, Modal, ModalBody, ModalCloseButton, ModalContent, ModalHeader, ModalOverlay, useDisclosure, Box, Text, RadioGroup, Radio, FormLabel } from "@chakra-ui/react"
...
const Login = () => {
    ...
    return (
        <Box>
            ...
            >
                <ModalOverlay />
                {value ? <ModalContent borderRadius="20px">
                    ...
                    <ModalBody pb={6}>
                        <FormControl>
                            ...
                            <InputBar ref={initialRef} placeholder='Enter Your Mobile Number' />
                        </FormControl>
                ...
                </ModalContent> : valid ? <ModalContent borderRadius="20px">
                    <ModalHeader> </ModalHeader>
                    <ModalCloseButton />
                ...
                </ModalContent> : isAuth ? <ModalContent borderRadius="20px" textAlign="center">
                    <ModalCloseButton />
                    <ModalHeader>Welcome to Fraazo!</ModalHeader>
                    <ModalBody p="20px" display="flex" justifyContent="center" alignItems="center">
                        <img src="https://www.froogal.ai/wp-content/uploads/2019/11/badge.png" width="40%" alt="" />
                    </ModalBody>
                    <ModalBody>Mobile No Verified </ModalBody>
                </ModalContent> : <ModalContent borderRadius="20px">
                    <form onSubmit={(e) => handleData(e)}>
                        ...
                        <ModalBody pb={6}>
                            <FormControl>
                                <div display="flex">
                                    <input ref={f_name} placeholder='First Name' style={{ outline: "none", borderBottom: "1px solid #43c6ac", marginRight: "35px" }} required />
                                    <input ref={l_name} placeholder='Last Name' style={{ outline: "none", borderBottom: "1px solid #43c6ac" }} required />
                                </div>
                                <InputBar ref={email} placeholder='Email Id' type="email" required />
                                <InputBar value={mNumber} placeholder='Mobile Number' required />

                                <RadioGroup onChange={(e) => setTitle(e)} display="flex" mt="20px" required>
                                    <Box mr={2}>Title :</Box>
                                    <Radio mr={2} value="Mr." name="title">Mr.</Radio>
                                    <Radio mr={2} value="Mrs." name="title">Mrs.</Radio>
                                    <Radio mr={2} value="Miss" name="title">Miss</Radio>
                                </RadioGroup>
                                        
                            </FormControl>
                        </ModalBody>
                        <FootBox >
                                        <Button ml="160px" bgColor="#43c6ac" color="white"
                                        borderRadius="10px" p="0px 30px">
                                Submit
                            </Button>
                        </FootBox>
                    </form>
