...
const OtpPage = () => {
    ...
    const [loading, setLoading] = useState(
        "https://raw.githubusercontent.com/shriram083/Fraazo-Clone/master/client/src/assets/yourRequestIseBeingProcessed.gif"
    );
    ...
    const verifyOtp = () => {
        ...
        if (userOtp == actualOtp) {
            ...
            setTimeout(() => {
                setLoading(
                    "https://raw.githubusercontent.com/shriram083/Fraazo-Clone/master/client/src/assets/dotsLoading.gif"
                );
                setLoadingText(
                    "Please do not press 'Back' or 'Refresh' button"
                );
            }, 2000);
            setTimeout(() => {
                onClose();
        ...
        >
            <Box>
                ...
                <Box p={"20px"} fontSize="15px">
                    The One Time Password has been sent to the below Mobile
                    Number. Please use the OTP and authenticate the transaction.
                </Box>
                <Box
                    rounded={"sm"}
                    fontSize="13px"
